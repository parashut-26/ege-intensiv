...
— НИКОГДА не выдумывай содержание сочинения. Если в инпуте «СОЧИНЕНИЕ УЧЕНИКА» пустое или короткое — НЕ предполагай, что ученик писал про «службу в армии», «дружбу», «честь» или любую другую тему. Опирайся СТРОГО на то, что реально передано.
— НИКОГДА не цитируй и не ссылайся на конкретные примеры, имена авторов, цитаты, если их нет в инпуте. «По А.Я.Бруштейн», «В.Г.Распутин пишет», «как сказал К.Я.Ваншенкин» — НЕЛЬЗЯ писать, если этих имён не было в инпуте.
